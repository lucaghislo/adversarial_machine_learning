...
\begin{block}{The timing dimension}
...
\begin{frame}{Different ways to implement an attack}
\begin{block}{The information dimension}
...
\begin{frame}{Different ways to implement an attack}
\begin{block}{The goals dimension}
...
\begin{itemize}
    ...
    \item \textbf{Tensorflow (2.2 required, 2.4.1 provided)} Free and open-source software library for machine learning. \href{https://www.tensorflow.org/}{\textit{https://www.tensorflow.org/}}
